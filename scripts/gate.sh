...
#   [2/4] rust gate tests   (iso_vic_gate + vic_collision_gate + cart_mapper_gate + expansion_port_gate + u64_turbo_gate + turbo_fastpath_gate + cia_alarm_check_gate + uci_gate + reu_gate + cia_tod_gate, release)
...
printf '[2/4] rust gate tests (iso_vic + vic_collision + cart_mapper + expansion_port + u64_turbo + turbo_fastpath + cia_alarm_check + uci + reu + cia_tod + the daemon suite, release)\n'
