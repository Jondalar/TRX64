...
impl FrameSink {
    ...
    /// the EXISTING read path (swimlane / map / taint — native since Spec 802,
    /// `trx64-traceindex`) identically to a live trace. Returns the number of records
    /// written (1 cpu row + N mem rows).
    ///
