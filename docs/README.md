...
**Closed specs are not here.** When a spec is BUILT, MERGED, RESOLVED or SUPERSEDED it moves
to [`_archive/`](_archive/README.md) and its row leaves this board. A folder of finished plans reads
