...
const CASES: ConfCase[] = [
  ...
  // Spec 804 (2026-09-19) removed the scenarios for the monitor's knowledge verbs
  // (misc-15 inspect/xref/sym, misc-16 label/note/.sym) and for resolvePc (misc-21):
  // TRX64 holds no symbols any more — names are joined in C64RE.
